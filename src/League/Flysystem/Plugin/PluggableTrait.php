...
trait PluggableTrait
{
     ...
     * @return mixed
     */
    protected function invokePlugin($method, array $arguments, FilesystemOperator $filesystem)
    {
    ...
    public function __call($method, array $arguments)
    {
        ...
        return $this->adapterMethod($method, $arguments);
    }
     ...
     * @return mixed
     */
    public function adapterMethod($method, $arguments): mixed
    {
